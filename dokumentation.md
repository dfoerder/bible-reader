...
| `bible-level-policy` | Levelanpassung nach einer Einheit: `ask` (Standard, fragen) · `auto` (anpassen) · `stay` (Level halten); migriert aus dem alten `bible-auto-level` |
